static const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
     *   | Home | End  | PgUp | PgDn | Fn0  |                                       |  Fn0 |  Dn  |  Up  |  Lt  | Rt   |
     *   `----------------------------------'                                       `----------------------------------'
     *                                        ,-------------.       ,-------------.
     *                                        | Tab  | Spc  |       | Ins  | Del  |
     *                                 ,------|------|------|       |------+------+------.
     ...
     * | LShift |   '  |   "  |   {  |   }  |   =  |------|           |------|   +  |   (  |   )  |   [  |   ]  | RShift |
     * |--------+------+------+------+------+------| Reset|           | Macro|------+------+------+------+------+--------|
     * | LCtrl  |   |  |   \  |   _  |  BS  |  Tab |      |           |      |   ~  |  Dn  |  Up  |  Lt  |  Rt  | RCtrl  |
     * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
     *   | Home | End  | PgUp | PgDn | Fn0  |                                       |  Fn0 |  Dn  |  Up  |  Lt  | Rt   |
     *   `----------------------------------'                                       `----------------------------------'
     *                                        ,-------------.       ,-------------.
    ...
    KEYMAP(  // layout: layer 0: default
        ...
        LSFT,A,   R,   S,   T,   D,
        LCTL,Z,   X,   C,   V,   B,   FN0,
        HOME,END, PGUP,PGDN,LGUI,
                                      TAB, ENT,
                                           SPC,
                                 ESC, FN0,LGUI,
        // right hand
             RBRC,6,   7,   8,   9,   0,   EQL,
             FN3, J,   U,   U,   Y,   SCLN,RALT,
                  H,   N,   E,   I,   O,   RSFT,
             FN4, K,   M,   COMM,DOT, SLSH,RCTL,
                       FN4, DOWN,UP,  LEFT,RGHT,
        INS, DEL,
        PGDN,
        BSPC, ENT, SPC
    ),
